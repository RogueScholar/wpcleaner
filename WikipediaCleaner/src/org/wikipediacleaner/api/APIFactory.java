...
public class APIFactory {
  ...
  static {
    ...
    HttpServer labs = new Hc5HttpServer(createHttpClient(connManager),
    "https://tools.wmflabs.org/"); */
    connectionManager = new MultiThreadedHttpConnectionManager();
    httpClient = createHttpClient(connectionManager);
    HttpServer labs =
        new Hc3HttpServer(httpClient, "https://tools.wmflabs.org/");
   ...
   */
  public static MediaWikiRESTAPI getRESTAPI() { return restApi; }

  /**
   * @return Access to Check Wiki project.
   */
  public static CheckWiki getCheckWiki() { return checkWiki; }
  ...
  createHttpClient(HttpClientConnectionManager manager) { return
  HttpClients.custom(). setConnectionManager(manager). setUserAgent("WPCleaner
