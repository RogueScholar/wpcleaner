...
public class Hc5HttpUtils extends HttpUtils {
   ...
   * @return HttpMethod.
   */
  public static HttpUriRequest createMethod(String url,
   ...
   */
  private static HttpPost createHttpPostMethod(String url,
                                               Map<String, String> properties)
    ...
    HttpPost method =
        new HttpPost(new URIBuilder(url, StandardCharsets.UTF_8).build());
   ...
   * @throws URISyntaxException Exception if the URL is not correct.
   */
  private static HttpGet createHttpGetMethod(String url,
                                             Map<String, String> properties)
      throws URISyntaxException {
