...
public abstract class CheckErrorAlgorithmBase implements CheckErrorAlgorithm {
   ...
   * @see
   *     org.wikipediacleaner.api.check.algorithm.CheckErrorAlgorithm#setConfiguration(org.wikipediacleaner.api.constants.CWConfigurationError)
   */
  @Override
   ...
   */
  public CheckErrorResult createCheckErrorResult(PageAnalysis analysis,
                                                 int startPosition,
                                                 int endPosition) {
  ...
  public String getSpecificProperty(String property, boolean useWiki,
    ...
    return configuration.getSpecificProperty(property, useWiki, useGeneral,
                                             useWiki, acceptEmpty);
  }
