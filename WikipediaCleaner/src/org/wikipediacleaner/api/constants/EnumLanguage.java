...
public enum EnumLanguage {
  ...
  EnumLanguage(Locale locale, String language) {
    ...
    try {
      ...
      // May happen if messages compiled with a more recent Java, but same
      // consequence as ClassNotFoundException
    }
    bundle = tmpBundle;
  }
  ...
  public static List<EnumLanguage> getList() {
    List<EnumLanguage> list =
        new ArrayList<EnumLanguage>(EnumLanguage.values().length);
   ...
   */
  public final ResourceBundle getResourceBundle() { return bundle; }
